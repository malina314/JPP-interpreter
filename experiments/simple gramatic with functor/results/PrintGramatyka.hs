...
instance Print (AbsGramatyka.Expr' a) where
  prt i = \case
    AbsGramatyka.EVar _ id_ -> prPrec i 0 (concatD [prt 0 id_])
    AbsGramatyka.ELitInt _ n -> prPrec i 0 (concatD [prt 0 n])
    AbsGramatyka.ELitTrue _ -> prPrec i 0 (concatD [doc (showString "true")])
    AbsGramatyka.ELitFalse _ -> prPrec i 0 (concatD [doc (showString "false")])
