...
instance Print AbsGramatyka.Expr where
  prt i = \case
    AbsGramatyka.EVar id_ -> prPrec i 0 (concatD [prt 0 id_])
    AbsGramatyka.ELitInt n -> prPrec i 0 (concatD [prt 0 n])
    AbsGramatyka.ELitTrue -> prPrec i 0 (concatD [doc (showString "true")])
    AbsGramatyka.ELitFalse -> prPrec i 0 (concatD [doc (showString "false")])
