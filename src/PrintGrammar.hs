...
instance Print (AbsGrammar.TopDef' a) where
  prt i = \case
    AbsGrammar.VarDef _ type_ item -> prPrec i 0 (concatD [doc (showString "global"), prt 0 type_, prt 0 item, doc (showString ";")])
...
instance Print (AbsGrammar.Arg' a) where
  prt i = \case
    ...
    AbsGrammar.ArgVar _ type_ id_ -> prPrec i 0 (concatD [doc (showString "var"), prt 0 type_, prt 0 id_])
...
instance Print (AbsGrammar.Stmt' a) where
  prt i = \case
    ...
    AbsGrammar.Decl _ type_ item -> prPrec i 0 (concatD [prt 0 type_, prt 0 item, doc (showString ";")])
