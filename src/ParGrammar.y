...
TopDef
  : 'global' Type Item ';' { (uncurry AbsGrammar.BNFC'Position (tokenLineCol $1), AbsGrammar.VarDef (uncurry AbsGrammar.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $3)) }
...
Arg
  ...
  | 'var' Type Ident { (uncurry AbsGrammar.BNFC'Position (tokenLineCol $1), AbsGrammar.ArgVar (uncurry AbsGrammar.BNFC'Position (tokenLineCol $1)) (snd $2) (snd $3)) }
...
Stmt
  ...
  | Type Item ';' { (fst $1, AbsGrammar.Decl (fst $1) (snd $1) (snd $2)) }
